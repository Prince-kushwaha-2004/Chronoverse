 ...
 * Get carts Items
 */
export const postCarts = <ThrowOnError extends boolean = false>(options: Options<PostCartsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostCartsResponses, PostCartsErrors, ThrowOnError>({
        responseType: 'json',
        url: '/carts',
        ...options,
        headers: {
 ...
 */
export const getGetStats = <ThrowOnError extends boolean = false>(options?: Options<GetGetStatsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetGetStatsResponses, unknown, ThrowOnError>({
        responseType: 'json',
        url: '/getStats',
        ...options
    });
