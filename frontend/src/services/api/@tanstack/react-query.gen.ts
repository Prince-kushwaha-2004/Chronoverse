...
import { type Options, postCarts, getOrders, postOrders, patchOrdersById, getProducts, postProducts, deleteProductsById, getProductsById, patchProductsById, postRegister, getLogin, postLogin, postLogout, getGetStats } from '../sdk.gen';
import { queryOptions, type UseMutationOptions, type DefaultError } from '@tanstack/react-query';
import type { PostCartsData, PostCartsResponse, GetOrdersData, PostOrdersData, PatchOrdersByIdData, GetProductsData, PostProductsData, DeleteProductsByIdData, DeleteProductsByIdResponse, GetProductsByIdData, PatchProductsByIdData, PostRegisterData, GetLoginData, PostLoginData, PostLoginResponse, PostLogoutData, GetGetStatsData } from '../types.gen';
...
export const postCartsQueryKey = (options: Options<PostCartsData>) => createQueryKey('postCarts', options);

/**
 * Get carts Items
 */
export const postCartsOptions = (options: Options<PostCartsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postCarts({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postCartsQueryKey(options)
    });
};
 ...
 * Get carts Items
 */
export const postCartsMutation = (options?: Partial<Options<PostCartsData>>): UseMutationOptions<PostCartsResponse, AxiosError<DefaultError>, Options<PostCartsData>> => {
    const mutationOptions: UseMutationOptions<PostCartsResponse, AxiosError<DefaultError>, Options<PostCartsData>> = {
...
export const getGetStatsQueryKey = (options?: Options<GetGetStatsData>) => createQueryKey('getGetStats', options);

/**
 * Total Products Statics
 */
export const getGetStatsOptions = (options?: Options<GetGetStatsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: getGetStatsQueryKey(options)
    });
};